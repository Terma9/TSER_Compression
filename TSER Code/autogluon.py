...
def run_agluon(source_path_train,source_path_test, experiment_name, run_name, time):
...
if __name__ == "__main__":
    ...
    run_agluon(args.source_path_train, args.source_path_test, args.experiment_name, args.run_name, args.time)
